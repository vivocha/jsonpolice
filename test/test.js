...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _index.register)('Subscription', {
	  type: 'object',
	  value: {
	    id: {
	      type: 'string',
	...
	try {
	  window.o = (0, _index.safeCreate)('Account', { limitations: { users: 35 } });
	  window.meta = _index.meta;
	} catch (e) {
	...
	var InitError = function (_Error2) {
	  ...
	  _createClass(InitError, [{
	    ...
	    value: function toString() {
	      var s = '';
	      for (var i = 0, e; this.errors && i < this.errors.length; i++) {
	        e = this.errors[i];
	        if (e instanceof DataError) {
	          s += e.name + ': ' + e.message + (e.path ? ' at ' + e.path : '') + '\n';
	        } else {
	          s += e.toString() + '\n';
	        }
	      }
